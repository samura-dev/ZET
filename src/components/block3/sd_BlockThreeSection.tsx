    ...
    <section className="sd_block-three" aria-label="Carry Art" ref={sd_sectionRef}>
      ...
      <div className="sd_block-three__top">
        ...
        <p className="sd_block-three__lead">
          Наша команда увлечена футуризмом и инновациями, и мы воплощаем эту страсть в каждой создаваемой нами сумке.
        </p>
      </div>
      ...
      <div className="sd_block-three__content">
        ...
        <div className="sd_block-three__text-column">
          <p className="sd_block-three__description">
            Мы любим экспериментировать с современными материалами, технологиями и формами, чтобы создавать продукты, которые
            не только отвечают вашим потребностям, но и вдохновляют на новые возможности. Вместе мы исследуем будущее моды и
            функциональности, создавая сумки, которые станут вашими верными спутниками в стремительном ритме современной жизни.
          </p>
        </div>
