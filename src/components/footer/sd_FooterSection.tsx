...
export const SdFooterSection = (): JSX.Element => {
  ...
  return (
    <footer className="sd-footer" aria-label="Подвал сайта HUSH" ref={sd_footerRef}>
      ...
      <div className="sd-footer__top">
        ...
        <p className="sd-footer__subtitle">футуристичные сумки на стыке формы, практичности и искусства</p>
      </div>

      <div className="sd-footer__content">
        <nav className="sd-footer__column" aria-label="Навигация футера">
          <h3 className="sd-footer__column-title">навигация</h3>
        ...
        <div className="sd-footer__column">
          <h3 className="sd-footer__column-title">контакты</h3>
          <ul className="sd-footer__list">
        ...
        <div className="sd-footer__column">
          <h3 className="sd-footer__column-title">доставка</h3>
          <ul className="sd-footer__list">
            <li>
              <p className="sd-footer__meta">по миру: 3-9 рабочих дней</p>
            </li>
            <li>
              <p className="sd-footer__meta">возврат: 14 дней</p>
            </li>
            <li>
              <p className="sd-footer__meta">поддержка: 24/7</p>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="sd-footer__bottom">
        <p className="sd-footer__meta">© {sd_currentYear} HUSH. Все права защищены.</p>
