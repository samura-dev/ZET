  ...
  return (
    <section className="sd_carry-art" ref={sd_sectionRef} aria-label="Art you can carry">
      <div className="sd_carry-art__grid">
        ...
        <article className="sd_carry-art__tile sd_carry-art__tile--chain" aria-label="Металлическая цепь">
        ...
        <article className="sd_carry-art__tile sd_carry-art__tile--liquid" aria-label="Жидкий металл">
          <div className="sd_carry-art__tile-media">
            <img
              className="sd_carry-art__tile-image"
        ...
        <article className="sd_carry-art__tile sd_carry-art__tile--fur" aria-label="Текстура меха">
          <div className="sd_carry-art__tile-media">
            <img
              className="sd_carry-art__tile-image"
