...
export const SdContactsPage = (): JSX.Element => {
  ...
  return (
    <section className="sd-contacts" ref={sd_ref}>
      <header className="sd-contacts__hero">
        <p className="sd-contacts__eyebrow">HUSH STUDIO / ALWAYS ONLINE</p>
        <h1>контакты</h1>
        <p>
      ...
      <div className="sd-contacts__grid">
        {sd_contactCards.map((sd_card) => (
          <article className="sd-contacts__card" key={sd_card.title}>
            <h2>{sd_card.title}</h2>
        ...
        <article className="sd-contacts__card sd-contacts__card--cta">
