...
const sd_aboutPoints: sd_AboutPoint[] = [
  {
    ...
    title: "производство",
    text:
      "Мы не верим в компромисс между формой и технологией. Каждая модель проходит лабораторию прототипов, ручную сборку и финальную шлифовку, чтобы визуальный акцент всегда был подкреплен точностью."
  },
  {
    id: "02",
  ...
  },
  {
    ...
    title: "качество",
    text:
      "Каждый материал проверяется по износостойкости, тактильности и визуальной чистоте. Мы добиваемся баланса между блеском и мягкостью, чтобы сумка сохраняла форму и характер годами."
  },
  {
    id: "04",
    title: "для кого",
    text:
      "Для тех, кто выбирает форму осознанно: смелые силуэты, архитектурные линии, технологичная отделка. HUSH / ZET — это аксессуары, которые говорят за вас прежде слов."
  }
];
      ...
      <section className="sd_about__vision sd_about__section">
        <div className="sd_about__vision-left">
          ...
          <a className="sd_about__vision-actions" href="/#catalog">
            <span className="sd_about__vision-button">каталог</span>
